...
%****************************************************************
\begin{Thm}
\include{Parties/algo_div}      %Problème typo 
\end{Thm}


%****************************************************************
\begin{demo}
Remarquons tout d'abord que lors de chaque itération de la boucle, une de ses deux instructions :
\begin{enumerate}
...
On obtient donc,lorsque $p=0$ (et on sait que cela arrivera), que  $f=\sum_{i=1}^s a_if_i+r$ et $r$ est, par définition dans l'algorithme, une somme d'éléments non divisibles par les $LT(f_i)$
\end{demo}