\begin{Def}
Soit $I=\left\langle f_1,\ldots,f_s \right\rangle $ un idéal de $k[X_1,\ldots,X_n]$. On appelle $k$ème idéal d'élimination de $I$ l'idéal $I_k$ de $k[X_{k+1},\ldots,X_n]$ définit par : $I_k=k[X_{k+1},\ldots,X_n] \cap I$
\end{Def}
