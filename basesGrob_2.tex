...
Supposons que $A=k [Y] $ . Alors : $\Res (f, g)\in\left\langle f,g \right \rangle \cap k[Y] $
...
\begin{itemize}
	...
	\item Soient $f,g \in k[X_1,\ldots,X_n]$. On note par $\Syl_{X_i}(f,g), \Res_{X_i}(f,g)$ la matrice de Sylvester (resp. résultant) de $f$ et $g$ vu comme polynôme de $k[X_1,\ldots,X_{i-1},X_{i+1},\ldots,X_n][X_i]$
\end{itemize}
\end{Not}
